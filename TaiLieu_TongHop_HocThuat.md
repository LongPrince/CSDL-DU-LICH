...
<p align="center"><i>Hình 3.3: Giao diện Danh sách người dùng</i></p>
...
<p align="center"><i>Hình 3.4: Giao diện Thông tin chi tiết người dùng</i></p>
...
<p align="center"><i>Hình 3.5: Giao diện Thêm mới người dùng</i></p>
...
<p align="center"><i>Hình 3.6: Giao diện Chỉnh sửa thông tin người dùng</i></p>
...
<p align="center"><i>Hình 3.7: Giao diện Xóa người dùng</i></p>
...
<p align="center"><i>Hình 3.8: Giao diện Danh sách địa bàn</i></p>
...
<p align="center"><i>Hình 3.10: Giao diện Thêm mới địa bàn</i></p>
...
<p align="center"><i>Hình 3.11: Thông báo thêm địa bàn thành công (Popup)</i></p>
...
<p align="center"><i>Hình 3.13: Thông báo thêm địa bàn thất bại / Cảnh báo lỗi (Popup)</i></p>
...
<p align="center"><i>Hình 3.14: Giao diện Chỉnh sửa địa bàn</i></p>
...
| **Tên chức năng** | **Mô tả** | **Thành công** | **Thất bại** |
| :--- | :--- | :--- | :--- |
| **Cập nhật dữ liệu** | Hệ thống lưu các thông tin chỉnh sửa mới vào CSDL dựa trên Mã địa bàn. | Thay đổi được cập nhật thành công, hiển thị thông báo popup báo tin vui và tự động chuyển về trang Danh sách địa bàn. | Người dùng xóa trống trường Tên địa bàn rồi bấm cập nhật → Hệ thống chặn lại, viền đỏ ô nhập liệu và báo lỗi "Tên địa bàn không được để trống". |
...
<p align="center"><i>Hình 3.15: Xóa Địa bàn (Popup Xác nhận xóa)</i></p>
...
| **Tên chức năng** | **Mô tả** | **Thành công** | **Thất bại** |
| :--- | :--- | :--- | :--- |
| **Xác nhận xóa** | Hệ thống kiểm tra ràng buộc khóa ngoại và thực hiện xóa bản ghi. | Bản ghi được xóa khỏi CSDL, popup đóng lại, màn hình danh sách cập nhật (biến mất dòng vừa xóa) và hiển thị Toast thông báo thành công. | Bản ghi đang có ràng buộc dữ liệu con → Hệ thống không xóa, giữ nguyên bản ghi và thông báo lỗi: "Không thể xóa do địa bàn đang có dữ liệu trực thuộc hoặc đang có cơ sở kinh doanh đăng ký". |
...
<p align="center"><i>Hình 3.16: Giao diện Danh sách Loại hình doanh nghiệp du lịch</i></p>
...
<p align="center"><i>Hình 3.17: Giao diện Danh sách Hồ sơ doanh nghiệp và Xem chi tiết</i></p>
...
<p align="center"><i>Hình 3.18: Giao diện Phê duyệt thông tin doanh nghiệp</i></p>
...
| **Từ chối hồ sơ** | Admin nhập lý do tại ô "Lý do từ chối" và nhấn nút Từ chối. | Hồ sơ chuyển sang trạng thái "Từ chối", lưu lại nội dung lý do phản hồi để hiển thị cho doanh nghiệp chỉnh sửa lại, quay về trang danh sách. | Admin bấm nút Từ chối nhưng bỏ trống ô "Lý do từ chối" → Hệ thống ngăn lại, báo đỏ tại ô nhập liệu và hiển thị cảnh báo "Vui lòng nhập lý do từ chối hồ sơ". |

#### d. Khai báo / thêm mới doanh nghiệp

<p align="center"><i>Hình 3.20: Giao diện Khai báo thông tin doanh nghiệp</i></p>
...
<p align="center"><i>Hình 3.21: Giao diện Danh sách Loại hình lưu trú</i></p>
...
| **Tìm kiếm loại hình** | Nhập từ khóa vào ô tìm kiếm và nhấn Enter hoặc icon kính lúp. | Bảng tự động làm mới, chỉ giữ lại các dòng loại hình lưu trú chứa từ khóa tìm kiếm. | Từ khóa không khớp với bất kỳ bản ghi nào → Bảng trả về trạng thái trống rỗng. |
...
<p align="center"><i>Hình 3.23: Giao diện Danh sách Loại hình dịch vụ du lịch</i></p>
...
<p align="center"><i>Hình 3.24: Giao diện Danh sách Loại hình điểm đến du lịch</i></p>
...
<p align="center"><i>Hình 3.25: Giao diện Danh sách Danh mục Các tiện ích</i></p>
...
*Hình 3.27: Giao diện Danh sách cơ sở lưu trú*
...
*Hình 3.28: Giao diện Xem chi tiết cơ sở lưu trú*
...
*Hình 3.29: Giao diện Thêm cơ sở lưu trú*
...
*Hình 3.30: Giao diện Sửa cơ sở lưu trú*
...
*Hình 3.31: Giao diện Xóa cơ sở lưu trú (Popup)*
...
*Hình 3.32: Giao diện Phê duyệt cơ sở lưu trú*
...
*Hình 3.33: Giao diện Từ chối phê duyệt (Popup)*
...
*Hình 3.34: Giao diện Danh sách đơn vị lữ hành*
...
*Hình 3.35: Giao diện Xem chi tiết đơn vị lữ hành*
...
*Hình 3.36: Giao diện Danh sách hướng dẫn viên*
...
*Hình 3.37: Giao diện Xem chi tiết hướng dẫn viên*
...
*Hình 3.40: Giao diện Danh sách tour du lịch*
...
*Hình 3.41: Giao diện Xem chi tiết tour du lịch*
...
*Hình 3.42: Giao diện Danh sách quán ăn và mua sắm*
...
*Hình 3.43: Giao diện Xem chi tiết quán ăn và mua sắm*
...
*Hình 3.44: Giao diện Danh sách điểm đến*
...
*Hình 3.45: Giao diện Xem chi tiết điểm đến*
...
*Hình 3.47: Giao diện Danh sách lễ hội và sự kiện*
...
*Hình 3.48: Giao diện Xem chi tiết lễ hội và sự kiện*
...
*Hình 3.49: Giao diện Quản lý phản hồi (Dành cho QTV)*
...
*Hình 3.50: Giao diện Quản lý phản hồi (Dành cho Doanh nghiệp)*
...
*Hình 3.51: Giao diện Tìm kiếm tổng hợp toàn hệ thống*
...
*Hình 3.52: Giao diện Quản lý cấu hình API hệ thống*
...
*Hình 3.53: Giao diện Báo cáo thống kê Dashboard*
